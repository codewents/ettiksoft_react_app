...
const HomePage = () => {
  ...
  return (
    <>
      <div className="our-services-section mt-3 mb-3">
        <h1>Our services</h1>
        <div className="our-services-list d-flex justify-content-center align-items-center p-3">
          {ourServicesList.map((service, index) => (
            <button key={index} onClick={() => handleButtonClick(index)}>Software Eng</button>
          ))}
        </div>
